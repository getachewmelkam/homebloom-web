  ...
  <div className="min-h-screen">
    ...
    <section className="pt-32 pb-16 bg-primary">
      <div className="container mx-auto px-4 text-center">
        ...
        <h1 className="font-serif text-5xl font-bold text-primary-foreground">About Prestige Estates</h1>
      </div>
    </section>
      ...
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-12">
        <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="bg-card p-10 rounded-lg shadow-property">
          ...
          <p className="text-muted-foreground leading-relaxed">
            To provide an unparalleled real estate experience by connecting discerning clients with exceptional properties through expert guidance, market intelligence, and personalized service that exceeds expectations at every touchpoint.
          </p>
        </motion.div>
        <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="bg-card p-10 rounded-lg shadow-property">
          <div className="w-12 h-12 rounded-full bg-gold/10 flex items-center justify-center mb-5">
          ...
          <p className="text-muted-foreground leading-relaxed">
            To be the most trusted name in luxury real estate, recognized for our integrity, innovation, and commitment to making every real estate transaction a seamless and rewarding experience for our clients.
          </p>
        </motion.div>
      </div>
    </section>
    ...
    <section className="py-20 bg-section-gradient">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <h2 className="font-serif text-4xl font-bold text-foreground">Meet Our Team</h2>
        </div>
