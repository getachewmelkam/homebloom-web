...
export const teamMembers = [
  { name: "Alemu Musa", role: "Lead Agent & Co-Founder", bio: "With over 15 years in luxury real estate, Sarah brings unmatched market expertise and a client-first approach." },
  { name: "Yohhanes Biruk", role: "Senior Property Advisor", bio: "James specializes in residential properties and has closed over $200M in transactions throughout his career." },
  { name: "Aster Aklilu", role: "Director of Sales", bio: "Victoria's strategic marketing background ensures every listing reaches the right buyers at the right time." },
  { name: "Kebede Menor", role: "Commercial Real Estate Expert", bio: "David brings 12 years of experience in commercial and mixed-use properties across major metropolitan markets." },
];
